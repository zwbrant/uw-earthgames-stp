...
public static class UpgradeDatabase {
    ...
    public static Dictionary<Upgrade.UpgradeType, Upgrade> bestCarbUpgrds = new Dictionary<Upgrade.UpgradeType, Upgrade>();
    public static Dictionary<Upgrade.UpgradeType, Upgrade> bestIncomeUpgrds = new Dictionary<Upgrade.UpgradeType, Upgrade>();

    //Delineates the available levels and how much XP is necessary for each one
    public static int[] levels = new int[] {0, 500, 1200, 3000, 6100, 12000, 20000, 48000, 66000, 80000, 100000}; 
	...
	public static void MakeUpgradeDB () {
		...
		upgrades.Add (new Upgrade ("Tire Pump", 2, "Use your left hand if you get bored", Resources.Load<Sprite>("vehicle manual pump"), 0.0f, 1.25f, 100.0f, Upgrade.UpgradeType.Tires, 30.0f, 0));
		upgrades.Add (new Upgrade ("Incandescent Lightbulbs", 3, "Don't use these", Resources.Load<Sprite>("Incandescent"), 3.0f, 0.0f, 0.0f, Upgrade.UpgradeType.Lightbulbs, 40.0f, 2));
		upgrades.Add (new Upgrade ("CFL Lightbulbs", 4, "It's white, it's bright, it's a kind of light", Resources.Load<Sprite>("CFL"), 2.0f, 1.25f, 5.5f, Upgrade.UpgradeType.Lightbulbs, 20.0f, 2));
		upgrades.Add (new Upgrade ("LED Lightbulbs", 5, "High-tech circa 2002", Resources.Load<Sprite>("LED"), 4.0f, 2.0f, 6.0f, Upgrade.UpgradeType.Lightbulbs, 10.0f, 0));
        ...
        upgrades.Add(new Upgrade("Electric Thermostat Adjustment", 12, "High tech free home improvement", Resources.Load<Sprite>("70degree"), 0.0f, 7.0f, 1500.0f, Upgrade.UpgradeType.Thermostats, 75.0f, 3));
        ...
        upgrades.Add(new Upgrade("Become Vegetarian", 15, "Is quite a vegetarian", Resources.Load<Sprite>("Vegetarian"), 0.0f, 22.5f, 1760.0f, Upgrade.UpgradeType.Diets, 90.0f, 4));
		...
		upgrades.Add (new Upgrade ("Electric Tire Pump", 18, "Use your left hand if you get bored", Resources.Load<Sprite>("ElectricPump"), 0.0f, 1.25f, 100.0f, Upgrade.UpgradeType.Tires, 10.0f, 0));
		upgrades.Add(new Upgrade("Coal", 19, "Save climate change while feeling awesomely high tech", Resources.Load<Sprite>("Coal"), 10.0f, 0.0f, 0.0f, Upgrade.UpgradeType.Electricity, 20.0f, 1));
