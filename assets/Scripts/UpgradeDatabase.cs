...
public static class UpgradeDatabase {
	...
	public static int[] levels = new int[] {0, 500, 2000, 5000, 12000, 19000, 40000, 48000, 66000, 80000, 100000}; 
	...
	public static void MakeUpgradeDB () {
		...
		upgrades.Add (new Upgrade ("Alder", 0, "Trees no longer needed", Resources.Load<Sprite>("Alder"), 0.0f, 0.0f, 0.0f, Upgrade.UpgradeType.Trees, 85.0f, 2));
		...
		upgrades.Add (new Upgrade ("Optimize PSI (Handpump)", 2, "Use your left hand if you get bored", Resources.Load<Sprite>("HandPump"), 0.0f, 1.25f, 100.0f, Upgrade.UpgradeType.Tires, 30.0f, 0));
		...
		upgrades.Add (new Upgrade ("Hybrid Car", 6, "Buy a hybrid instead of a non hybrid!", Resources.Load<Sprite>("Hybrid"), 1500.0f, 42.0f, 3300.0f, Upgrade.UpgradeType.Cars, 90.0f, 0));
		upgrades.Add (new Upgrade ("Old Car", 7, "Carbureted inefficiency", Resources.Load<Sprite>("OldCar"), 20.0f, -3.0f, -5.0f, Upgrade.UpgradeType.Cars, 50.0f, 1));
        upgrades.Add(new Upgrade("Poorly Inflated Tire", 8, "Too high, too low - neither goes", Resources.Load<Sprite>("FlatTire"), 0.0f, 0.0f, 0.0f, Upgrade.UpgradeType.Tires, 5.0f, 1));
        upgrades.Add(new Upgrade("Road Bike", 9, "Bikes are the best thing ever -Every Biker Ever", Resources.Load<Sprite>("RoadBike"), 200.0f, 12.5f, 1000.0f, Upgrade.UpgradeType.Cars, 50.0f, 3));
		...
		modifiers.Add (new Upgrade("2x Income, .5x Duration Bonus", 0, "2x Money, .5x Duration Multiplier", Resources.Load<Sprite>("2x Cash"), -.5f, 0, 0, -0.5f, Upgrade.UpgradeType.All));
